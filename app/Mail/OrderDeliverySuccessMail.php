...
class OrderDeliverySuccessMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Đơn hàng đã được giao thành công - Đơn hàng #' . $this->order->id, // Tiêu đề email
        );
    }
    ...
    {
        return new Content(
            html: 'sites.emails.order_success',
            with: [
