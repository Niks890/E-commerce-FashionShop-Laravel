...
class ChatBotApiController extends Controller
{
    ...
    // CÁCH MỚI DÙNG LIST TRONG REDIS
    // public function sendMessage(Request $request)
    // {
    ...
    //     $maxMessages = 10;
    //     $summarizeThreshold = 6; // Khi số tin nhắn vượt ngưỡng này thì tóm tắt
    ...
    //                 'role' => 'system',
    //                 'message' => "Tóm tắt lịch sử chat trước đây: " . $summaryText
    //             ]);

    //             // Xoá toàn bộ key cũ và lưu lại lịch sử mới đã tóm tắt vào Redis
    ...
    //     // Tách riêng system nếu có
    //     foreach ($recentHistory as $item) {
    //         if ($item->role === 'system' && empty($systemMsg)) {
    ...
    //     // Ghép lại với user message cuối
    //     $chatPrompt = ($systemMsg ? "SYSTEM: $systemMsg\n" : '') . $chatPrompt;
