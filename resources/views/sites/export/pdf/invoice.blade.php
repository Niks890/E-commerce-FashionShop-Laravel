...
<head>
    ...
    <style>
        ...
        .info-box:first-child {
            padding-right: 10px; /* Reduced space between info boxes */
        }
        ...
        table {
            ...
            border-collapse: collapse;
            margin-top: 15px; /* Reduced margin */
            font-size: 9.5px; /* Reduced font size for table data */
        }
        ...
        .signature-table {
            width: 100%;
            border-collapse: collapse;
            margin-top: 30px; /* Reduced space before signatures */
        }
        ...
        .summary-table strong {
            font-size: 12px; /* Reduced font size for total */
            color: #333;
        }
...
<body>
    <div class="invoice-box">
        ...
        <table class="info-table">
            <tr>
                ...
                <td class="info-box" style="padding-left: 10px;">
                    ...
                    <p><strong>Ngày đặt hàng:</strong> {{ \Carbon\Carbon::parse($orderDetail[0]->created_at)->format('d/m/Y H:i') }}</p>
        ...
        <p style="text-align: center; margin-top: 15px; color: #666; font-style: italic;">Cảm ơn quý khách đã mua hàng tại TST Fashion!</p>
    </div>
</body>
